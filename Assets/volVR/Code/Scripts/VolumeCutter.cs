...
public class VolumeCutter : MonoBehaviour {
    ...
    private void WriteRendererProps(bool cutting = true) {
        ...
        props.SetVector("_CutterPosition", new Vector4(cutterPosition.x, cutterPosition.y, cutterPosition.z, 1));
        props.SetVector("_CutterNormal", new Vector4(cutterNormal.x, cutterNormal.y, cutterNormal.z, 1));
        props.SetFloat("_Cutting", cutting ? 1 : 0);
